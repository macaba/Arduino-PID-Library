#ifndef FastFloatPID_h
#define FastFloatPID_h
...
class FastFloatPID
{
  ...
  //commonly used functions **************************************************************************
    FastFloatPID(float*, float*, float*,        // * constructor.  links the PID to the Input, Output, and 
  ...
  //available but not commonly used functions ********************************************************
    ...
    void SetSampleTime(float);            // * sets the frequency, in seconds, default is 0.1
